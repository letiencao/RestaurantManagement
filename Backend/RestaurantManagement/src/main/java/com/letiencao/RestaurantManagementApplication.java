...
import com.letiencao.service.impl.CustomerService;
import com.letiencao.service.impl.OrderService;
import com.letiencao.service.impl.ReservationService;
import com.letiencao.service.impl.RoleService;
import com.letiencao.service.impl.TableSeatingService;
...
public class RestaurantManagementApplication {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = SpringApplication.run(RestaurantManagementApplication.class, args);
...
//			System.out.println("Hello = "+System.currentTimeMillis());
		...
		Date date = null;
		try {
			date = (Date) dtf.parse(dtf.format(System.currentTimeMillis()));
		} catch (ParseException e) {
			e.printStackTrace();
		}
		long longDate = date.getTime();
